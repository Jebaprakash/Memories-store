...
export const ProductCard = ({ product }) => {
    ...
    return (
        ...
        >
            {/* Image Container - Flipkart style square image */}
            <div className="relative aspect-square overflow-hidden bg-slate-50">
                ...
                {/* Category Badge (Optional, but looks premium) */}
            ...
            {/* Content Container - Compact Flipkart style */}
            <div className="p-3 sm:p-4 flex flex-col flex-grow">
                ...
                <div className="flex items-baseline gap-2 mb-4">
                    ...
                    {/* Mock discount for premium look */}
                    <span className="text-[10px] sm:text-xs text-slate-400 line-through">₹{(parseFloat(product.price) * 1.4).toFixed(0)}</span>
